...
inline app_runtime::XInputKeySymbolType ToAppruntimeXInputKeySymbolType(
    SpecialKeySymbolType symbol_type) {
  switch (symbol_type) {
    case QT_KEY_SYMBOL:
      return app_runtime::XInputKeySymbolType::XINPUT_QT_KEY_SYMBOL;
    case NATIVE_KEY_SYMBOL:
      return app_runtime::XInputKeySymbolType::XINPUT_NATIVE_KEY_SYMBOL;
  }
  NOTREACHED();
}

inline app_runtime::XInputEventType ToAppruntimeXInputEventType(
    XInputEventType event_type) {
  switch (event_type) {
    case XINPUT_PRESS_AND_RELEASE:
      return app_runtime::XInputEventType::XINPUT_PRESS_AND_RELEASE;
    case XINPUT_PRESS:
      return app_runtime::XInputEventType::XINPUT_PRESS;
    case XINPUT_RELEASE:
      return app_runtime::XInputEventType::XINPUT_RELEASE;
  }
  NOTREACHED();
}
